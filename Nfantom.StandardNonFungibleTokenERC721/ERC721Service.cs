...
using Nfantom.StandardNonFungibleTokenERC721.ContractDefinition;

namespace Nfantom.StandardNonFungibleTokenERC721
{
    public partial class ERC721Service
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Nfantom.Web3.Web3 web3, ERC721Deployment eRC721Deployment, CancellationTokenSource cancellationTokenSource = null)
        {
        ...
        public static Task<string> DeployContractAsync(Nfantom.Web3.Web3 web3, ERC721Deployment eRC721Deployment)
        {
            return web3.Eth.GetContractDeploymentHandler<ERC721Deployment>().SendRequestAsync(eRC721Deployment);
        }
        public static async Task<ERC721Service> DeployContractAndGetServiceAsync(Nfantom.Web3.Web3 web3, ERC721Deployment eRC721Deployment, CancellationTokenSource cancellationTokenSource = null)
        {
        ...
        protected Nfantom.Web3.Web3 Web3{ get; }

        public ContractHandler ContractHandler { get; }

        public ERC721Service(Nfantom.Web3.Web3 web3, string contractAddress)
        {
            Web3 = web3;
