...
using Nfantom.Contracts.Builders;
...
namespace Nfantom.Contracts
{
    public class Function<TFunctionInput> : FunctionBase
    {
        ...
        {
            return CallAsync<TReturn>(CreateCallInputParameterless());
        }

        public Task<TReturn> CallAsync<TReturn>(TFunctionInput functionInput)
        {
            return CallAsync<TReturn>(CreateCallInput(functionInput));
        }
        ...
        public Task<TReturn> CallAsync<TReturn>(TFunctionInput functionInput, string from, HexBigInteger gas,
            HexBigInteger value)
        {
            return CallAsync<TReturn>(CreateCallInput(functionInput, from, gas, value));
        }

        public Task<TReturn> CallAsync<TReturn>(TFunctionInput functionInput, string from, HexBigInteger gas,
            HexBigInteger value, BlockParameter block)
        {
            return CallAsync<TReturn>(CreateCallInput(functionInput, from, gas, value), block);
        }

        public Task<TReturn> CallAsync<TReturn>(TFunctionInput functionInput,
            BlockParameter blockParameter)
        {
            return CallAsync<TReturn>(CreateCallInput(functionInput), blockParameter);
        }

        public Task<TReturn> CallDeserializingToObjectAsync<TReturn>() where TReturn : new()
        {
            return CallAsync(new TReturn(), CreateCallInputParameterless());
        }

        public Task<TReturn> CallDeserializingToObjectAsync<TReturn>(BlockParameter block) where TReturn : new()
        {
            return CallAsync(new TReturn(), CreateCallInputParameterless(), block);
        }

        public Task<TReturn> CallDeserializingToObjectAsync<TReturn>(TFunctionInput functionInput) where TReturn : new()
        {
            return CallAsync(new TReturn(), CreateCallInput(functionInput));
        }

        public Task<TReturn> CallDeserializingToObjectAsync<TReturn>(TFunctionInput functionInput, BlockParameter block)
            where TReturn : new()
        {
            return CallAsync(new TReturn(), CreateCallInput(functionInput), block);
        }
        ...
        {
            return CallAsync(new TReturn(), CreateCallInput(functionInput, from, gas, value));
        }
        ...
        {
            return CallAsync(new TReturn(), CreateCallInput(functionInput, from, gas, value), block);
        }
        ...
        {
            return SendTransactionAsync(CreateTransactionInput(functionInput, from));
        }

        public Task<string> SendTransactionAsync(TFunctionInput functionInput, string from, HexBigInteger gas,
            HexBigInteger value)
        {
            return SendTransactionAsync(CreateTransactionInput(functionInput, from, gas, value));
        }
        ...
        public Task<string> SendTransactionAsync(TFunctionInput functionInput, string from, HexBigInteger gas,
            ...
            HexBigInteger value)
        {
            return SendTransactionAsync(CreateTransactionInput(functionInput, from, gas, gasPrice, value));
        }
        ...
        {
            return CallRawAsync(CreateCallInputParameterless());
        }

        public Task<byte[]> CallRawAsync<TReturn>(TFunctionInput functionInput)
        {
            return CallRawAsync(CreateCallInput(functionInput));
        }

        public Task<byte[]> CallRawAsync(TFunctionInput functionInput, string from, HexBigInteger gas,
            HexBigInteger value)
        {
            return CallRawAsync(CreateCallInput(functionInput, from, gas, value));
        }

        public Task<byte[]> CallRawAsync(TFunctionInput functionInput, string from, HexBigInteger gas,
            HexBigInteger value, BlockParameter block)
        {
            return CallRawAsync(CreateCallInput(functionInput, from, gas, value), block);
        }

        public Task<byte[]> CallRawAsync(TFunctionInput functionInput,
            BlockParameter blockParameter)
        {
            return CallRawAsync(CreateCallInput(functionInput), blockParameter);
        }
        ...
        {
            return SendTransactionAndWaitForReceiptAsync(CreateTransactionInput(functionInput, from),
        ...
        {
            return SendTransactionAndWaitForReceiptAsync(CreateTransactionInput(functionInput, from, gas, value),
                receiptRequestCancellationToken);
        }
        ...
        public Task<TransactionReceipt> SendTransactionAndWaitForReceiptAsync(TFunctionInput functionInput, string from,
            ...
            HexBigInteger value, CancellationTokenSource receiptRequestCancellationToken = null)
        {
            return SendTransactionAndWaitForReceiptAsync(
            ...
            TransactionInput input, CancellationTokenSource receiptRequestCancellationToken = null)
        {
            var encodedInput = GetData(functionInput);
            input.Data = encodedInput;
            return SendTransactionAndWaitForReceiptAsync(input, receiptRequestCancellationToken);
        }
#endif
    }
}
