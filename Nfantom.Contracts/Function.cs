...
namespace Nfantom.Contracts
{
    public class Function : FunctionBase
    {
        ...
        {
            return CallDecodingToDefaultAsync(CreateCallInput(functionInput));
        }

        public Task<List<ParameterOutput>> CallDecodingToDefaultAsync(string from, HexBigInteger gas,
            HexBigInteger value, params object[] functionInput)
        {
            return CallDecodingToDefaultAsync(CreateCallInput(from, gas, value, functionInput));
        }

        public Task<List<ParameterOutput>> CallDecodingToDefaultAsync(string from, HexBigInteger gas,
            HexBigInteger value, BlockParameter block, params object[] functionInput)
        {
            return CallDecodingToDefaultAsync(CreateCallInput(from, gas, value, functionInput), block);
        }

        public Task<List<ParameterOutput>> CallDecodingToDefaultAsync(BlockParameter block, params object[] functionInput)
        {
            return CallDecodingToDefaultAsync(CreateCallInput(functionInput), block);
        }
        ...
        public Task<TReturn> CallAsync<TReturn>(string from, HexBigInteger gas,
            HexBigInteger value, params object[] functionInput)
        {
            return CallAsync<TReturn>(CreateCallInput(from, gas, value, functionInput));
        }

        public Task<TReturn> CallAsync<TReturn>(string from, HexBigInteger gas,
            HexBigInteger value, BlockParameter block, params object[] functionInput)
        {
            return CallAsync<TReturn>(CreateCallInput(from, gas, value, functionInput), block);
        }

        public Task<TReturn> CallAsync<TReturn>(BlockParameter block, params object[] functionInput)
        {
            return CallAsync<TReturn>(CreateCallInput(functionInput), block);
        }
        ...
        {
            return CallAsync(new TReturn(), CreateCallInput(from, gas, value, functionInput));
        }

        public Task<TReturn> CallDeserializingToObjectAsync<TReturn>(string from, HexBigInteger gas,
            HexBigInteger value, BlockParameter block, params object[] functionInput) where TReturn : new()
        {
            return CallAsync(new TReturn(), CreateCallInput(from, gas, value, functionInput), block);
        }
        ...
        {
            return CallAsync(new TReturn(), CreateCallInput(functionInput), blockParameter);
        }
