...
namespace Nfantom.BlockchainProcessing.BlockStorage.Entities.Mapping
{
    ...
    {
        public static Block MapToStorageEntityForUpsert(this Nfantom.RPC.Eth.DTOs.Block source)
        {
            return new Block().MapToStorageEntityForUpsert(source);
        }

        public static TEntity MapToStorageEntityForUpsert<TEntity>(this Nfantom.RPC.Eth.DTOs.Block source) where TEntity : Block, new()
        {
            return new TEntity().MapToStorageEntityForUpsert(source);
        }

        public static TEntity MapToStorageEntityForUpsert<TEntity>(this TEntity block, Nfantom.RPC.Eth.DTOs.Block source) where TEntity : Block
        {
            block.Map(source);
        ...
        public static void Map(this Block block, Nfantom.RPC.Eth.DTOs.Block source)
        {
        ...
        private static int TransactionCount(Nfantom.RPC.Eth.DTOs.Block block)
        {
